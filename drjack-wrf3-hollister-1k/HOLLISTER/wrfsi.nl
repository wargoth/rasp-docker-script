...
&hgridspec
 ...
 PARENT_ID = 1, 1
 RATIO_TO_PARENT = 1, 5
 DOMAIN_ORIGIN_LLI = 1, 8
 DOMAIN_ORIGIN_LLJ = 1, 8
 DOMAIN_ORIGIN_URI = 38, 30
 DOMAIN_ORIGIN_URJ = 42, 34
 MAP_PROJ_NAME = 'lambert'
 MOAD_KNOWN_LAT = 36.71
 MOAD_KNOWN_LON = -121.43
 MOAD_STAND_LATS = 40, 40
 MOAD_STAND_LONS = -77
 MOAD_DELTA_X = 5000
 MOAD_DELTA_Y = 5000
 SILAVWT_PARM_WRF = 0.
